			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" id="bank">
				...
				<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
				    ...
				    <div class="fi-left pull-left">
				      ...
				      <strong>0906966375</strong>
				    </div>
				     <div class="fi-right pull-right">
				      <p><small>Giờ làm(8h00 - 22h00)</small></p>
				      <strong>0906966375</strong>
				    </div>
				  </div>
			</div>
		...
		<div class="row" id="footer">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
					<address>
					  <strong>   <b style="color:yellow">D</b><b style="color:green">S</b><b style="color:blue">V</b> <b style="color:red">STORE</b> </strong><br>
					  <span class="glyphicon glyphicon-home" aria-hidden="true"></span> Địa chỉ: 475A Điện Biên Phủ, Phường 25, Bình Thạnh, Thành phố Hồ Chí Minh<br>
					  <span class="glyphicon glyphicon-phone" aria-hidden="true"></span> Điện thoại: 0906966375<br>
					  Copyright ©2021 - Design by DSVTEAM---
					</address>
				</div>
